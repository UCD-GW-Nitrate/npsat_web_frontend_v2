...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from 'D:/work/UCD/DiSSC_2020/front_end/npsat/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from 'D:/work/UCD/DiSSC_2020/front_end/npsat/node_modules/warning/warning.js';

import { plugin } from '../core/umiExports';

export * from 'D:/work/UCD/DiSSC_2020/front_end/npsat/node_modules/react-intl';
...
export const localeInfo: {[key: string]: any} = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/work/UCD/DiSSC_2020/front_end/npsat/src/locales/en-US.js')),
    },
    locale: 'en-US',
    antd: {
...
export const getIntl = (locale?: string, changeIntl?: boolean) => {
  ...
  // 使用 zh-CN
  if (localeInfo["us-EN"]) return createIntl(localeInfo["us-EN"]);
